...
describe('UMD Losstests', () => {
    ...
    it('Make a query to a fake level 2 region should return no data', async () => {
        nock(process.env.CT_URL)
            ...
            .query({
                sql: 'SELECT%20iso%2C%20SUM(total_area)%20AS%20area%2C%20SUM(total_gain)%20AS%20gain%2C%20%20SUM(extent_2000)%20AS%20extent2000%2C%20SUM(extent_2010)%20AS%20extent2010%2C%20SUM(weighted_biomass_per_ha)%20AS%20biomass_density%20%20FROM%20data%20WHERE%20iso%3D%27FOO%27%20AND%20adm1%20%3D%201%20AND%20adm2%20%3D%201%20AND%20threshold%20%3D%2030'
            })
            .reply(200, {
                "data": []
                });
        ...
        nock(process.env.CT_URL)
            .get('/v1/query/10e124f0-3703-41e3-8136-492b131d5326')
            .query({
                sql: 'SELECT%20iso%2C%20adm1%2C%20adm2%2C%20year_data.year%20as%20year%2C%20SUM(year_data.area_loss)%20as%20area_loss%2C%20%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20SUM(year_data.carbon_emissions)%20as%20emissions%2C%20%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20FROM%20data%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20WHERE%20iso%20%3D%20%27FOO%27%0AAND%20adm1%20%3D%201%0AAND%20adm2%20%3D%201%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20AND%20threshold%20%3D%20%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20GROUP%20BY%20nested(year_data.year)'
            })
            .reply(500, {});
    ...
    it('Make a query to a real level 1 region should return ...', async () => {
        ...
        nock(process.env.CT_URL)
            .get('/v1/query/10e124f0-3703-41e3-8136-492b131d5326')
            .query({ sql: 'SELECT%20iso%2C%20adm1%2C%20adm2%2C%20year_data.year%20as%20year%2C%20SUM(year_data.area_loss)%20as%20area_loss%2C%20%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20SUM(year_data.carbon_emissions)%20as%20emissions%2C%20%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20FROM%20data%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20WHERE%20iso%20%3D%20%27BRA%27%0AAND%20adm1%20%3D%201%0AAND%20adm2%20%3D%201%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20AND%20threshold%20%3D%20%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20GROUP%20BY%20nested(year_data.year)' })
            .reply(200, jsonResponse);

        nock(process.env.CT_URL)
            .get('/v1/query/10e124f0-3703-41e3-8136-492b131d5326')
            .query({ sql: "SELECT iso, SUM(total_area) AS area, SUM(total_gain) AS gain,  SUM(extent_2000) AS extent2000, SUM(extent_2010) AS extent2010, SUM(weighted_biomass_per_ha) AS biomass_density  FROM data WHERE iso='BRA' AND adm1 = 1 AND adm2 = 1 AND threshold = 30" })
            .reply(200, jsonResponse);
